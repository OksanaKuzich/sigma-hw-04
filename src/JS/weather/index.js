import * as fetchRequest from './fetchRequest';
...
const listEl = document.querySelector('.cities__list');
const findBtnEl = document.querySelector('.btn__find');
const diagramEl = document.querySelector('.container__diagram');
...
async function onSubmitForm(e) {
  ...
  const btnMoreEl = document.querySelector('.btn__more');
